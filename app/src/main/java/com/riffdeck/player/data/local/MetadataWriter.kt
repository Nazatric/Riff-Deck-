package com.riffdeck.player.data.local
...
import com.riffdeck.player.extensions.media.createAlbumArtThumbFile
import com.riffdeck.player.extensions.media.deleteAlbumArt
import com.riffdeck.player.extensions.media.insertAlbumArt
...
class MetadataWriter : KoinComponent {
    ...
    private fun createPicture(target: EditTarget): Picture? {
        ...
        return Picture(
            data = byteArray,
            description = "Embedded Front Cover - RiffDeck",
