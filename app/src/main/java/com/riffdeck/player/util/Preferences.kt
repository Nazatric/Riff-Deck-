...
package com.riffdeck.player.util
...
import com.riffdeck.player.core.model.Cutoff
import com.riffdeck.player.core.model.action.FolderAction
...
import com.riffdeck.player.core.model.action.SongClickBehavior
...
import com.riffdeck.player.core.model.player.PlayerTransition
import com.riffdeck.player.core.model.shuffle.GroupShuffleMode
import com.riffdeck.player.core.model.theme.AppTheme
import com.riffdeck.player.core.model.theme.NowPlayingScreen
import com.riffdeck.player.extensions.files.getCanonicalPathSafe
import com.riffdeck.player.extensions.hasQ
import com.riffdeck.player.extensions.intRes
import com.riffdeck.player.extensions.utilities.calendarSingleton
import com.riffdeck.player.extensions.utilities.deserialize
import com.riffdeck.player.extensions.utilities.getCutoffTimeMillis
import com.riffdeck.player.extensions.utilities.serialize
import com.riffdeck.player.extensions.utilities.toEnum
import com.riffdeck.player.ui.component.views.TopAppBarLayout
...
object Preferences : KoinComponent {
    ...
    // RiffDeck: the Material You settings toggle was removed (dark-only,
    // fixed rock/metal/Y2K palette — see preferences_screen_appearance.xml
    // and NowPlayingScreen supportedColorSchemes). Previously this defaulted
    // to hasS() (true on Android 12+), which would silently pull in
    // wallpaper-derived dynamic color for every Compose screen even with no
    // way left in Settings to disable it. Hardcoded to false.
    ...
    var miniPlayerShadeMode: Boolean
        get() = preferences.getBoolean(MINI_PLAYER_SHADE_MODE, false)
        set(value) = preferences.edit { putBoolean(MINI_PLAYER_SHADE_MODE, value) }
...
const val MINI_PLAYER_SHADE_MODE = "mini_player_shade_mode"
