...
import com.riffdeck.player.databinding.ActivityTagEditorBinding
...
abstract class AbsTagEditorActivity : AbsBaseActivity(),
    ...
    protected open fun selectImage() {
        val items = arrayOf(
            getString(com.riffdeck.player.R.string.download_image),
            getString(com.riffdeck.player.R.string.pick_from_local_storage),
            getString(com.riffdeck.player.R.string.web_search),
            getString(com.riffdeck.player.R.string.restore_default),
            getString(com.riffdeck.player.R.string.remove_cover)
        )
        MaterialAlertDialogBuilder(this)
            .setTitle(com.riffdeck.player.R.string.update_image)
    ...
    private fun writeTags() {
        viewModel.write(this, propertyMap).observe(this) { result ->
            if (result.isLoading) {
                ...
                showToast(com.riffdeck.player.R.string.saving_changes)
            } else {
                binding.actionSave.show()
                if (result.isSuccess) {
                    showToast(com.riffdeck.player.R.string.changes_saved_successfully)
                } else {
                    showToast(com.riffdeck.player.R.string.could_not_save_some_changes)
                }
            }
        }
    }
