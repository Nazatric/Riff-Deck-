...
import com.riffdeck.player.databinding.FragmentMainRecyclerBinding
import com.riffdeck.player.extensions.createTooltipBalloon
...
import com.riffdeck.player.ui.dialogs.playlists.ImportPlaylistDialog
import com.riffdeck.player.ui.screen.other.ShuffleModeFragment
    ...
    override fun onStart() {
        ...
        _binding?.shuffleButton?.doOnLayout {
            viewLifecycleOwner.lifecycleScope.launch {
                delay(1000)
                val balloon = createTooltipBalloon("shuffle_button_tip") {
