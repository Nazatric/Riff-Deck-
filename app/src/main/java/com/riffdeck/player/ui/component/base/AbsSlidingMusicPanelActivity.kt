...
package com.riffdeck.player.ui.component.base
...
import com.riffdeck.player.MediaControllerOwner
import com.riffdeck.player.R
import com.riffdeck.player.core.model.CategoryInfo
import com.riffdeck.player.core.model.LibraryMargin
import com.riffdeck.player.core.model.action.QueueClearingBehavior
import com.riffdeck.player.core.model.theme.NowPlayingScreen
import com.riffdeck.player.data.model.search.SearchQuery
import com.riffdeck.player.databinding.SlidingMusicPanelLayoutBinding
import com.riffdeck.player.extensions.applyWindowInsets
import com.riffdeck.player.extensions.currentFragment
import com.riffdeck.player.extensions.dip
import com.riffdeck.player.extensions.getBottomInsets
import com.riffdeck.player.extensions.hasT
import com.riffdeck.player.extensions.isLandscape
import com.riffdeck.player.extensions.launchAndRepeatWithViewLifecycle
import com.riffdeck.player.extensions.resources.darkenColor
import com.riffdeck.player.extensions.resources.hide
import com.riffdeck.player.extensions.resources.isColorLight
import com.riffdeck.player.extensions.resources.peekHeightAnimate
import com.riffdeck.player.extensions.resources.show
import com.riffdeck.player.extensions.whichFragment
import com.riffdeck.player.ui.IBackConsumer
import com.riffdeck.player.ui.screen.info.PlayInfoFragment
import com.riffdeck.player.ui.screen.library.LibraryViewModel
import com.riffdeck.player.ui.screen.library.search.SearchFragment
import com.riffdeck.player.ui.screen.lyrics.LyricsEditorFragment
import com.riffdeck.player.ui.screen.lyrics.LyricsViewModel
import com.riffdeck.player.ui.screen.other.MiniPlayerFragment
import com.riffdeck.player.ui.screen.permissions.PermissionsActivity
import com.riffdeck.player.ui.screen.player.PlayerViewModel
import com.riffdeck.player.ui.screen.player.styles.defaultstyle.DefaultPlayerFragment
import com.riffdeck.player.ui.screen.player.styles.expressivestyle.ExpressivePlayerFragment
import com.riffdeck.player.ui.screen.player.styles.fullcoverstyle.FullCoverPlayerFragment
import com.riffdeck.player.ui.screen.player.styles.gradientstyle.GradientPlayerFragment
import com.riffdeck.player.ui.screen.player.styles.m3style.M3PlayerFragment
import com.riffdeck.player.ui.screen.player.styles.peekplayerstyle.PeekPlayerFragment
import com.riffdeck.player.ui.screen.player.styles.plainstyle.PlainPlayerFragment
import com.riffdeck.player.ui.screen.player.styles.riffdeck.RiffDeckPlayerFragment
import com.riffdeck.player.util.ADAPTIVE_CONTROLS
import com.riffdeck.player.util.ADD_EXTRA_CONTROLS
import com.riffdeck.player.util.CAROUSEL_EFFECT
import com.riffdeck.player.util.CIRCLE_PLAY_BUTTON
import com.riffdeck.player.util.ENABLE_ROTATION_LOCK
import com.riffdeck.player.util.HOLD_TAB_TO_SEARCH
import com.riffdeck.player.util.LIBRARY_CATEGORIES
import com.riffdeck.player.util.NOW_PLAYING_IMAGE_CORNER_RADIUS
import com.riffdeck.player.util.NOW_PLAYING_SCREEN
import com.riffdeck.player.util.NOW_PLAYING_SMALL_IMAGE
import com.riffdeck.player.util.PLAYER_BLUR_RADIUS
import com.riffdeck.player.util.Preferences
import com.riffdeck.player.util.SQUIGGLY_SEEK_BAR
import com.riffdeck.player.util.SWIPE_DOWN_TO_DISMISS
import com.riffdeck.player.util.TAB_TITLES_MODE
...
abstract class AbsSlidingMusicPanelActivity : AbsBaseActivity(),
    ...
    private fun chooseFragmentForTheme() {
        ...
        val fragment: AbsPlayerFragment = when (nowPlayingScreen) {
            ...
            NowPlayingScreen.RiffDeck -> RiffDeckPlayerFragment()
