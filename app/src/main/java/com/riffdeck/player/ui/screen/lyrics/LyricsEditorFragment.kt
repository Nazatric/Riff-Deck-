...
import com.riffdeck.player.databinding.DialogLyricsSelectorBinding
import com.riffdeck.player.databinding.DialogSongSearchBinding
import com.riffdeck.player.databinding.FragmentLyricsEditorBinding
...
import com.riffdeck.player.extensions.resources.animateToggle
...
class LyricsEditorFragment : AbsMainActivityFragment(R.layout.fragment_lyrics_editor) {
    ...
    private fun applyCheckedButtonState(lyrics: LyricsResult, checkedId: Int, isChecked: Boolean) {
        ...
        if (source.tooltipKey.isNotEmpty()) {
            val balloon = createTooltipBalloon(source.tooltipKey) {
