package com.riffdeck.player.ui.component.compose.lyrics
...
private fun LyricsTextView(
    ...
    val shadow = if (shadowEffect && selectedLine) {
        // RiffDeck: neon-red glow (amp indicator light) instead of a plain
        // dimmed copy of the text color, matching the rock/metal/Y2K accent
        // used throughout the rest of the skin (see RiffDeckColor.NeonRed).
        Shadow(
            color = Color(0xFFFF5A6E).copy(alpha = .6f),
