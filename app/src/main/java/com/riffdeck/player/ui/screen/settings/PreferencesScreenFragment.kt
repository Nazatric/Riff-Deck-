...
package com.riffdeck.player.ui.screen.settings
...
import com.riffdeck.player.coil.CoverProvider
import com.riffdeck.player.core.model.lyrics.LyricsViewSettings
import com.riffdeck.player.data.local.room.InclExclDao
import com.riffdeck.player.data.model.network.ScrobblingService
import com.riffdeck.player.extensions.files.getFormattedFileName
import com.riffdeck.player.extensions.hasR
import com.riffdeck.player.extensions.hasS
import com.riffdeck.player.extensions.isTablet
import com.riffdeck.player.extensions.materialSharedAxis
import com.riffdeck.player.extensions.navigation.findActivityNavController
import com.riffdeck.player.extensions.requestContext
import com.riffdeck.player.extensions.showToast
import com.riffdeck.player.extensions.utilities.dateStr
import com.riffdeck.player.extensions.utilities.toEnum
import com.riffdeck.player.ui.component.preferences.ProgressIndicatorPreference
import com.riffdeck.player.ui.component.preferences.SwitchWithButtonPreference
import com.riffdeck.player.ui.component.preferences.dialog.ActionOnCoverPreferenceDialog
import com.riffdeck.player.ui.component.preferences.dialog.CategoriesPreferenceDialog
import com.riffdeck.player.ui.component.preferences.dialog.ClearQueueActionPreferenceDialog
import com.riffdeck.player.ui.component.preferences.dialog.ExtraInfoPreferenceDialog
import com.riffdeck.player.ui.component.preferences.dialog.NowPlayingScreenPreferenceDialog
import com.riffdeck.player.ui.component.preferences.dialog.SingleSelectionDialog
import com.riffdeck.player.ui.component.preferences.dialog.SongClickActionPreferenceDialog
import com.riffdeck.player.ui.dialogs.MultiCheckDialog
import com.riffdeck.player.ui.dialogs.library.BlacklistWhitelistDialog
import com.riffdeck.player.ui.screen.library.LibraryViewModel
import com.riffdeck.player.ui.screen.library.ReloadType
import com.riffdeck.player.ui.screen.scrobbling.ScrobblingServiceLoginFragment
import com.riffdeck.player.ui.screen.lyrics.LyricsViewModel
import com.riffdeck.player.ui.screen.update.UpdateSearchResult
import com.riffdeck.player.ui.screen.update.UpdateViewModel
import com.riffdeck.player.util.ADD_EXTRA_CONTROLS
import com.riffdeck.player.util.BACKUP_DATA
import com.riffdeck.player.util.BLACKLIST_ENABLED
import com.riffdeck.player.util.BLACK_THEME
import com.riffdeck.player.util.BackupContent
import com.riffdeck.player.util.BackupHelper
import com.riffdeck.player.util.COVER_DOUBLE_TAP_ACTION
import com.riffdeck.player.util.COVER_LEFT_DOUBLE_TAP_ACTION
import com.riffdeck.player.util.COVER_LONG_PRESS_ACTION
import com.riffdeck.player.util.COVER_RIGHT_DOUBLE_TAP_ACTION
import com.riffdeck.player.util.COVER_SINGLE_TAP_ACTION
import com.riffdeck.player.util.ENABLE_ROTATION_LOCK
import com.riffdeck.player.util.GENERAL_THEME
import com.riffdeck.player.util.IGNORE_MEDIA_STORE
import com.riffdeck.player.util.LANGUAGE_NAME
import com.riffdeck.player.util.LASTFM_LOGIN
import com.riffdeck.player.util.LAST_ADDED_CUTOFF
import com.riffdeck.player.util.LIBRARY_CATEGORIES
import com.riffdeck.player.util.LISTENBRAINZ_LOGIN
import com.riffdeck.player.util.MATERIAL_YOU
import com.riffdeck.player.util.NOW_PLAYING_EXTRA_INFO
import com.riffdeck.player.util.NOW_PLAYING_SCREEN
import com.riffdeck.player.util.ON_CLEAR_QUEUE_ACTION
import com.riffdeck.player.util.ON_SONG_CLICK_ACTION
import com.riffdeck.player.util.PREFERRED_IMAGE_SIZE
import com.riffdeck.player.util.Preferences
import com.riffdeck.player.util.RESTORE_DATA
import com.riffdeck.player.util.TRASH_MUSIC_FILES
import com.riffdeck.player.util.USE_CUSTOM_FONT
import com.riffdeck.player.util.USE_FOLDER_ART
import com.riffdeck.player.util.WHITELIST_ENABLED
import com.riffdeck.player.util.WIDGET_IMAGE_CORNER_RADIUS
import com.riffdeck.player.util.WIDGET_THIRD_LINE_CONTENT
...
open class PreferenceScreenFragment : PreferenceFragmentCompat(),
    ...
    fun preparePreferences() {
        ...
        // RiffDeck: light/dark theme picker and Material You dynamic color
        // toggle removed (dark-only design, forced in App.kt). See
        // preferences_screen_appearance.xml for the corresponding XML removal.

        findPreference<Preference>(BLACK_THEME)?.apply {
            setOnPreferenceChangeListener { _, newValue ->
                // RiffDeck: always resolve to a dark night-mode value here.
                // GeneralTheme.LIGHT is unreachable through the UI (the
                // picker was removed), but Preferences.getDayNightMode()
                // would still honor a stored "light" value if one somehow
                // existed, which would silently fight App.kt's forced dark
                // mode. MODE_NIGHT_YES is used unconditionally instead.
