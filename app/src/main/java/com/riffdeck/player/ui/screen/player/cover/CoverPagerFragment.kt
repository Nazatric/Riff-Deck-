...
import com.riffdeck.player.databinding.FragmentPlayerAlbumCoverBinding
import com.riffdeck.player.extensions.isLandscape
import com.riffdeck.player.extensions.keepScreenOn
...
import com.riffdeck.player.extensions.resources.RIFFDECK_ANIM_TIME
import com.riffdeck.player.ui.adapters.pager.CustomFragmentStatePagerAdapter
import com.riffdeck.player.ui.component.base.AbsPlayerFragment
import com.riffdeck.player.ui.component.transform.CarouselPagerTransformer
...
import com.riffdeck.player.ui.screen.player.cover.page.ImageFragment
import com.riffdeck.player.ui.screen.player.cover.page.ImageFragment.ColorReceiver
import com.riffdeck.player.util.Preferences
import com.riffdeck.player.util.SWIPE_ON_COVER
...
class CoverPagerFragment : Fragment(R.layout.fragment_player_album_cover),
    ...
    fun showLyrics(isForced: Boolean = false) {
        ...
        animatorSet.duration = RIFFDECK_ANIM_TIME
        animatorSet.doOnEnd {
