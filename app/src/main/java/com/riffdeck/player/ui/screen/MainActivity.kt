package com.riffdeck.player.ui.screen
...
import com.riffdeck.player.extensions.navigation.isValidCategory
...
import com.riffdeck.player.ui.component.base.AbsSlidingMusicPanelActivity
import com.riffdeck.player.ui.screen.update.UpdateDialog
...
class MainActivity : AbsSlidingMusicPanelActivity(), MediaController.Listener {
    ...
    companion object {
        private const val APP_SHORTCUT_LAST_ADDED = "com.riffdeck.player.shortcut.LAST_ADDED"
        private const val APP_SHORTCUT_TOP_TRACKS = "com.riffdeck.player.shortcut.TOP_TRACKS"
        private const val APP_SHORTCUT_SHUFFLE = "com.riffdeck.player.shortcut.SHUFFLE"
        private const val APP_SHORTCUT_FAVORITES = "com.riffdeck.player.shortcut.FAVORITES"

        private val OLD_SHORTCUT_IDS = listOf(
            "com.riffdeck.player.appshortcuts.id.last_added",
            "com.riffdeck.player.appshortcuts.id.top_tracks",
            "com.riffdeck.player.appshortcuts.id.shuffle_all",
        )
    }
}