...
package com.riffdeck.player.ui.screen.library.artists
...
import com.riffdeck.player.coil.artistImage
import com.riffdeck.player.core.sort.AlbumSortMode
import com.riffdeck.player.core.sort.SongSortMode
import com.riffdeck.player.core.sort.SortMode
import com.riffdeck.player.data.mapper.searchFilter
import com.riffdeck.player.data.model.Album
import com.riffdeck.player.data.model.Artist
import com.riffdeck.player.data.model.Song
import com.riffdeck.player.data.remote.lastfm.model.LastFmArtist
import com.riffdeck.player.databinding.FragmentArtistDetailBinding
import com.riffdeck.player.extensions.applyHorizontalWindowInsets
import com.riffdeck.player.extensions.defaultGridColumns
import com.riffdeck.player.extensions.dp
import com.riffdeck.player.extensions.isLandscape
import com.riffdeck.player.extensions.materialSharedAxis
import com.riffdeck.player.extensions.media.artistInfo
import com.riffdeck.player.extensions.media.displayName
import com.riffdeck.player.extensions.navigation.albumDetailArgs
import com.riffdeck.player.extensions.navigation.artistDetailArgs
import com.riffdeck.player.extensions.navigation.asFragmentExtras
import com.riffdeck.player.extensions.navigation.playInfoArgs
import com.riffdeck.player.extensions.navigation.searchArgs
import com.riffdeck.player.extensions.plurals
import com.riffdeck.player.extensions.resources.removeHorizontalMarginIfRequired
import com.riffdeck.player.extensions.resources.setupStatusBarForeground
import com.riffdeck.player.extensions.resources.surfaceColor
import com.riffdeck.player.extensions.setSupportActionBar
import com.riffdeck.player.playback.shuffle.OpenShuffleMode
import com.riffdeck.player.ui.IAlbumCallback
import com.riffdeck.player.ui.IArtistCallback
import com.riffdeck.player.ui.ISongCallback
import com.riffdeck.player.ui.adapters.HeaderAdapter
import com.riffdeck.player.ui.adapters.HorizontalListAdapter
import com.riffdeck.player.ui.adapters.SectionHeaderAdapter
import com.riffdeck.player.ui.adapters.WikiAdapter
import com.riffdeck.player.ui.adapters.album.SimpleAlbumAdapter
import com.riffdeck.player.ui.adapters.artist.ArtistAdapter
import com.riffdeck.player.ui.adapters.song.SimpleSongAdapter
import com.riffdeck.player.ui.component.base.AbsMainActivityFragment
import com.riffdeck.player.ui.component.menu.onAlbumsMenu
import com.riffdeck.player.ui.component.menu.onArtistMenu
import com.riffdeck.player.ui.component.menu.onArtistsMenu
import com.riffdeck.player.ui.component.menu.onSongMenu
import com.riffdeck.player.ui.component.menu.onSongsMenu
