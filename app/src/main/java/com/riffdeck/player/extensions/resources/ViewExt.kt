...
package com.riffdeck.player.extensions.resources
...
import com.riffdeck.player.ui.component.views.MorphicIconButton
...
const val RIFFDECK_ANIM_TIME = 350L
...
fun View.show(animate: Boolean = false, onCompleted: AnimationCompleted? = null) {
    if (!animate) {
        ...
        this.animate()
            .alpha(1f)
            .setDuration(RIFFDECK_ANIM_TIME)
            .withStartAction {
...
inline fun Context.createTooltipBalloon(
    tooltipId: String,
    lifecycleOwner: LifecycleOwner,
