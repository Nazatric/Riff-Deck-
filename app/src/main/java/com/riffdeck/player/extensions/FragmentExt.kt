...
import com.riffdeck.player.extensions.resources.createTooltipBalloon
...
inline fun Fragment.createTooltipBalloon(
    tooltipId: String,
    crossinline block: Balloon.Builder.() -> Unit
) = requestContext { it.createTooltipBalloon(tooltipId, viewLifecycleOwner, block = block) }
