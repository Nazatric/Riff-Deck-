...
import com.riffdeck.player.util.GeneralTheme
...
class AppTheme private constructor(
    ...
    enum class Mode(@StyleRes val themeRes: Int) {
        Light(R.style.Theme_RiffDeck_Light),
        Dark(R.style.Theme_RiffDeck),
        Black(R.style.Theme_RiffDeck_Black),
        FollowSystem(R.style.Theme_RiffDeck_FollowSystem)
    }
