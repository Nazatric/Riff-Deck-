...
package com.riffdeck.player.core.model.theme

import androidx.annotation.DrawableRes
import androidx.annotation.LayoutRes
import androidx.annotation.StringRes
import com.riffdeck.player.R
import com.riffdeck.player.core.model.player.PlayerColorSchemeList
...
enum class NowPlayingScreen(
    ...
    RiffDeck(
        R.string.riffdeck_style,
        R.drawable.np_riffdeck,
        R.layout.fragment_album_cover_default,
        buttonStyle = NowPlayingButtonStyle.Normal,
        supportsCoverLyrics = true,
        supportsCarouselEffect = false,
    ...
    val defaultColorScheme: PlayerColorSchemeMode
        get() = when (this) {
            Default, Plain, Peek, RiffDeck -> PlayerColorSchemeMode.AppTheme
